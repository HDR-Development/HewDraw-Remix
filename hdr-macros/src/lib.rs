...
macro_rules! blend_effect_rgb {
    //(fighter_kind: i32, effect_varconst: i32, start_frame: f32, end_frame: f32, i: f32, start_color: Vector3f, end_color: Vector3f, is_weapon: bool) => {
    ($fighter_kind:expr, $effect_handler:expr, $start_frame:expr, $end_frame:expr, ($r1:expr, $g1:expr, $b1:expr), ($r2:expr, $g2:expr, $g3:expr), $is_article:expr) => {
        ...
        for i in $start_frame..=$end_frame {
            ...
            // Apply color shift
            EffectModule::set_rgb(eff_handle as u32, blend_vector.x, blend_vector.y, blend_vector.z);
        }
    };
}