...
#[acmd_script( agent = "richter", script = "sound_damageflyhi" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "richter", script = "sound_damageflylw" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "richter", script = "sound_damageflyn" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "richter", script = "sound_damageflyroll" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "richter", script = "sound_damageflytop" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "richter", script = "game_escapeair" , category = ACMD_GAME , low_priority)]
...
#[acmd_script( agent = "richter_whip", script = "game_guardon" , category = ACMD_GAME , low_priority)]
unsafe fn richter_whip_attack_guardon_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
pub fn install() {
    install_acmd_scripts!(
        ...
        appeallwr_sound,
        appeallwl_sound,
        richter_whip_attack_guardon_game
    );
}
