...
unsafe fn richter_attack_air_b_hi_game(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
		...
		ATTACK(fighter, 0, 0, Hash40::new("top"), 13.0, 361, 90, 0, 40, 3.0, 0.0, 12.4, -5.6, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RICHTER_WHIP, *ATTACK_REGION_PUNCH);
...
unsafe fn richter_attack_air_b_hi_effect(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 12.0);
    if is_excute(fighter) {
        EFFECT_FOLLOW(fighter, Hash40::new("sys_attack_arc_b"), Hash40::new("top"), -2.5, 14.7, -4.3, 35, 140, 60, 1.0, false);
    }
    frame(lua_state, 14.0);
    if is_excute(fighter) {
        EFFECT_FOLLOW_ALPHA(fighter, Hash40::new("sys_attack_impact"), Hash40::new("top"), 0, 8.5, -16, 0, 0, 0, 1.2, true, 0.9);
    }
}
...
unsafe fn richter_attack_air_b_effect(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        EFFECT_FOLLOW_ALPHA(fighter, Hash40::new("sys_attack_line_b"), Hash40::new("top"), 0, 17.5, 4, -213, 9, 0, 1.2, true, 0.8);
