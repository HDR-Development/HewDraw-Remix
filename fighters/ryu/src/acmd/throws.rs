...
#[acmd_script( agent = "ryu", script = "game_throwf" , category = ACMD_GAME , low_priority)]
...
#[acmd_script( agent = "ryu", script = "game_throwb" , category = ACMD_GAME , low_priority)]
...
#[acmd_script( agent = "ryu", script = "game_throwlw" , category = ACMD_GAME , low_priority)]
...
#[acmd_script( agent = "ryu", script = "game_throwhi" , category = ACMD_GAME , low_priority)]
