...
unsafe extern "C" fn game_specials(agent: &mut L2CAgentBase) {
    ...
    FT_MOTION_RATE_RANGE(agent, 10.0, 28.0, 13.0);
    if is_excute(agent) {
...
unsafe extern "C" fn game_specialhi(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 26.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 1, Hash40::new("top"), 1.3, 90, 100, 12, 0, 5.0, 0.0, 16.0, 5.5, None, None, None, 0.0, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_rush"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
