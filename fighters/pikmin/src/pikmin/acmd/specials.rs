...
unsafe extern "C" fn game_spsthrown_v(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        if (WorkModule::is_flag(boma, *WEAPON_PIKMIN_PIKMIN_INSTANCE_WORK_ID_FLAG_TAKE_FROM_POCKET)) {
            ATTACK(agent, 0, 0, Hash40::new("hip"), 6.0, 361, 74, 0, 60, 4.5, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_SPEED, false, -2.5, 0.0, 0, true, false, false, false, false, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PIKMIN);
            ATTACK(agent, 1, 0, Hash40::new("hip"), 6.0, 361, 74, 0, 60, 4.5, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_SPEED, false, -2.5, 0.0, 0, true, false, false, false, false, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PIKMIN);
        } else {
            ATTACK(agent, 0, 0, Hash40::new("top"), 10.4, 361, 80, 0, 40, 4.5, 0.0, 3.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, -5.2, 0.0, 0, true, false, false, false, false, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PIKMIN);   
...
pub fn install(agent: &mut Agent) {
    agent.acmd("game_spsremved", game_spsremved, Priority::Low);
    agent.acmd("game_spsremved_b", game_spsremved, Priority::Low);
    agent.acmd("game_spsremved_v", game_spsremved, Priority::Low);
    agent.acmd("game_spsremved_w", game_spsremved, Priority::Low);
    agent.acmd("game_spsremved_y", game_spsremved, Priority::Low);

    agent.acmd("game_splwairrespond", game_spsremved, Priority::Low);
    agent.acmd("game_splwairrespond_b", game_spsremved, Priority::Low);
    agent.acmd("game_splwairrespond_v", game_spsremved, Priority::Low);
    agent.acmd("game_splwairrespond_w", game_spsremved, Priority::Low);
    agent.acmd("game_splwairrespond_y", game_spsremved, Priority::Low);

    agent.acmd("game_spntakenoutstart", game_spntakenoutstart, Priority::Low);
    agent.acmd("game_spntakenoutstart_y", game_spntakenoutstart, Priority::Low);
    agent.acmd("game_spntakenoutstart_b", game_spntakenoutstart, Priority::Low);
    agent.acmd("game_spntakenoutstart_w", game_spntakenoutstart, Priority::Low);
    agent.acmd("game_spntakenoutstart_v", game_spntakenoutstart, Priority::Low);
    
    agent.acmd("game_spsthrown", game_spsthrown, Priority::Low);
    agent.acmd("game_spsthrown_b", game_spsthrown_b, Priority::Low);
    agent.acmd("game_spsthrown_v", game_spsthrown_v, Priority::Low);
    agent.acmd("game_spsthrown_w", game_spsthrown_w, Priority::Low);
    agent.acmd("game_spsthrown_y", game_spsthrown_y, Priority::Low);
}