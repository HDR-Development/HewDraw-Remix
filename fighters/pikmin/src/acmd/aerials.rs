...
unsafe fn pikmin_attack_air_n_common(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        let damage = 11.0;
        ATTACK(fighter, 0, 0, Hash40::new("head2"), damage * pikmin.damage, 75 + pikmin.delta_angle, 100, 0, 40, 2.5, 2.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 1, 0, Hash40::new("head2"), damage * pikmin.damage, 75 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 2, 0, Hash40::new("head1"), damage * pikmin.damage, 75 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 3, 0, Hash40::new("waist"), damage * pikmin.damage, 75 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        HitModule::set_status_all(boma, app::HitStatus(*HIT_STATUS_XLU), 0);
    }
    frame(lua_state, 10.0);
    if is_excute(fighter) {
        let damage = 9.5;
        ATTACK(fighter, 0, 0, Hash40::new("head2"), damage * pikmin.damage, 62 + pikmin.delta_angle, 100, 0, 40, 2.5, 2.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 1, 0, Hash40::new("head2"), damage * pikmin.damage, 62 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 2, 0, Hash40::new("head1"), damage * pikmin.damage, 62 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 3, 0, Hash40::new("waist"), damage * pikmin.damage, 62 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
    }
    frame(lua_state, 17.0);
    if is_excute(fighter) {
        let damage = 8.0;
        ATTACK(fighter, 0, 0, Hash40::new("head2"), damage * pikmin.damage, 50 + pikmin.delta_angle, 100, 0, 40, 2.5, 2.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 1, 0, Hash40::new("head2"), damage * pikmin.damage, 50 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 2, 0, Hash40::new("head1"), damage * pikmin.damage, 50 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 3, 0, Hash40::new("waist"), damage * pikmin.damage, 50 + pikmin.delta_angle, 100, 0, 40, 3.0, 0.0, 0.0, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
    }
...
unsafe fn pikmin_attack_air_b_common(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        let damage = 15.0;
        ATTACK(fighter, 0, 0, Hash40::new("head1"), damage * pikmin.damage, 40 + pikmin.delta_angle, 112 - pikmin.kbg, 0, 40, 4.0, 0.0, 5.5, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        ATTACK(fighter, 1, 0, Hash40::new("head1"), damage * pikmin.damage, 40 + pikmin.delta_angle, 112 - pikmin.kbg, 0, 30, 4.0, 0.0, -1.5, 0.0, None, None, None, pikmin.hitlag, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, damage * pikmin.shield_damage, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new(pikmin.attr), *ATTACK_SOUND_LEVEL_L, pikmin.sound, *ATTACK_REGION_PIKMIN);
        HitModule::set_status_all(boma, app::HitStatus(*HIT_STATUS_XLU), 0);
    }
