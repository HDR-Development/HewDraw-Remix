...
#[acmd_script( agent = "brave", script = "game_specials1" , category = ACMD_GAME , low_priority)]
...
unsafe fn brave_special_air_s1_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
#[acmd_script( agent = "brave", script = "game_specials2" , category = ACMD_GAME , low_priority)]
...
unsafe fn brave_special_air_s2_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
#[acmd_script( agent = "brave", script = "game_specialhi1" , category = ACMD_GAME , low_priority)]
...
#[acmd_script( agent = "brave", script = "game_specialairhi1" , category = ACMD_GAME , low_priority)]
unsafe fn brave_special_air_hi1_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
unsafe fn brave_special_air_hi2_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
#[acmd_script( agent = "brave", script = "game_specialhi3" , category = ACMD_GAME , low_priority)]
...
unsafe fn brave_special_air_hi3_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
pub fn install() {
    install_acmd_scripts!(
        ...
        brave_special_air_s1_game,
        brave_special_s2_game,
        brave_special_air_s2_game,
        brave_special_hi1_game,
        brave_special_air_hi1_game,
        brave_special_hi2_game,
        brave_special_air_hi2_game,
        brave_special_hi3_game,
        brave_special_air_hi3_game,
    );
}
