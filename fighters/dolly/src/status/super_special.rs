...
pub unsafe extern "C" fn super_special_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_DOLLY_STATUS_KIND_SUPER_SPECIAL, super_special_pre);
}