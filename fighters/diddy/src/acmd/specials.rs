...
pub fn install(agent: &mut Agent) {
    ...
    agent.acmd("effect_specialncancel", stub, Priority::Low);
    agent.acmd("sound_specialncancel", stub, Priority::Low);
    agent.acmd("expression_specialncancel", stub, Priority::Low);
    agent.acmd("game_specialairncancel", game_specialncancel, Priority::Low);
    agent.acmd("effect_specialairncancel", stub, Priority::Low);
    agent.acmd("sound_specialairncancel", stub, Priority::Low);
    agent.acmd("expression_specialairncancel", stub, Priority::Low);
