...
unsafe fn teleport_logic(fighter: &mut L2CFighterCommon, boma: &mut BattleObjectModuleAccessor) {
    if fighter.is_status(*FIGHTER_STATUS_KIND_SPECIAL_HI) && !VarModule::is_flag(fighter.battle_object, vars::zelda::instance::GROUNDED_TELEPORT) {
        if fighter.global_table[SITUATION_KIND] == SITUATION_KIND_GROUND {
            VarModule::on_flag(fighter.battle_object, vars::mewtwo::instance::GROUNDED_TELEPORT);
    ...
    if fighter.is_status(*FIGHTER_MEWTWO_STATUS_KIND_SPECIAL_HI_2) {
        if StatusModule::is_changing(boma) {
            if boma.get_num_used_jumps() < boma.get_jump_count_max() {
                VarModule::on_flag(fighter.battle_object, vars::mewtwo::instance::TELEPORT_CANCEL);
                if !VarModule::is_flag(fighter.battle_object, vars::mewtwo::instance::GROUNDED_TELEPORT) {
                ...
                VarModule::on_flag(fighter.battle_object, vars::common::instance::IS_FLOAT);
                VarModule::off_flag(fighter.battle_object, vars::mewtwo::instance::TELEPORT_CANCEL);
            }
            VarModule::off_flag(fighter.battle_object, vars::mewtwo::instance::GROUNDED_TELEPORT);
    ...
    && VarModule::is_flag(fighter.battle_object, vars::mewtwo::instance::TELEPORT_CANCEL)
