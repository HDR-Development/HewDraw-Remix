...
unsafe fn buddy_attack_lw3_game(fighter: &mut L2CAgentBase) {
    ...
    for _ in 0..6 {
        if is_excute(fighter) {
            let neg_speed = smash::phx::Vector3f {x: -0.15, y: 0.0, z: 0.0};
