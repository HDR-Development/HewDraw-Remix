...
unsafe extern "C" fn game_attackairn(agent: &mut L2CAgentBase) {
    ...
    for _ in 0..4 {
        if is_excute(agent) {
            ...
            ATTACK(agent, 3, 0, Hash40::new("head"), 2.0, 366, 50, 0, 28, 4.0, 0.0, 0.0, 0.0, None, None, None, 0.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_MAGIC);
            // Ground-only
            ...
            ATTACK(agent, 7, 0, Hash40::new("head"), 2.0, 80, 50, 0, 28, 4.0, 0.0, 0.0, 0.0, None, None, None, 0.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_MAGIC);
        }
        wait(lua_state, 2.0);
        if is_excute(agent) {
...
unsafe extern "C" fn sound_attackairf(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        SoundModule::play_se(boma, Hash40::new("se_zelda_attackair_f01"), true, false, false, false, app::enSEType(0));
        SoundModule::set_se_pitch_ratio(boma, Hash40::new("se_zelda_attackair_f01"), 0.96);
    }
}
...
unsafe extern "C" fn game_attackairlw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 1, 0, Hash40::new("footl"), 9.0, 275, 85, 0, 10, 4.3, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn effect_attackairlw(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 3.0);
    if is_excute(agent) {
        EFFECT(agent, Hash40::new("sys_smash_flash"), Hash40::new("top"), 0, -1, 0, 0, 0, 0, 0.8, 0, 0, 0, 0, 0, 0, true);
    }
