...
unsafe extern "C" fn build_main(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    if sv_battle_object::kind(owner_id) == *FIGHTER_KIND_ZELDA {
        VarModule::set_int(zelda, vars::zelda::instance::PHANTOM_OBJECT_ID, weapon.battle_object_id as i32);
        if VarModule::is_flag(zelda, vars::zelda::instance::FORWARD_PHANTOM) {
            ...
            VarModule::off_flag(zelda, vars::zelda::instance::FORWARD_PHANTOM);
        }
    }
    ret
}
