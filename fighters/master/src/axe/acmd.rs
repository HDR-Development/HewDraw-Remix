...
unsafe extern "C" fn game_speciallw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        if VarModule::get_int(owner_module_accessor.object(), vars::master::instance::SPECIAL_LW_HOLD) > 0 {
            WorkModule::set_int(boma, 0, *WEAPON_MASTER_AXE_INSTANCE_WORK_ID_INT_CRITICAL_ATTACK_ID);
        }
        if VarModule::get_int(owner_module_accessor.object(), vars::master::instance::SPECIAL_LW_HOLD) == 0 {
            ATTACK(agent, 0, 0, Hash40::new("haver"), 18.0, 51, 93, 0, 60, 5.7, 0.0, 14.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 24, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MASTER_AXE, *ATTACK_REGION_OBJECT);
            ATK_SET_SHIELD_SETOFF_MUL(agent, 0, 3.0);
        }
        else if VarModule::get_int(owner_module_accessor.object(), vars::master::instance::SPECIAL_LW_HOLD) == 1 {
            // Ground-only
            ATTACK(agent, 0, 0, Hash40::new("haver"), 30.0, 51, 93, 0, 60, 5.7, 0.0, 14.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 72, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MASTER_AXE, *ATTACK_REGION_OBJECT);
            // Air-only
            ATTACK(agent, 1, 0, Hash40::new("haver"), 30.0, 275, 50, 0, 20, 5.7, 0.0, 14.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 72, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MASTER_AXE, *ATTACK_REGION_OBJECT);
        }
    }
    frame(lua_state, 63.0);
    if is_excute(agent) {
        if owner_module_accessor.is_situation(*SITUATION_KIND_AIR)
        && VarModule::get_int(owner_module_accessor.object(), vars::master::instance::SPECIAL_LW_HOLD) == 0 {
...
unsafe extern "C" fn effect_speciallwhit(agent: &mut L2CAgentBase) {
    ...
    let owner_module_accessor = &mut *sv_battle_object::module_accessor((WorkModule::get_int(boma, *WEAPON_INSTANCE_WORK_ID_INT_LINK_OWNER)) as u32);
    if is_excute(agent) {
        if VarModule::get_int(owner_module_accessor.object(), vars::master::instance::SPECIAL_LW_HOLD) == 2 {
