...
unsafe extern "C" fn status_AttackAir_Main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && !VarModule::is_flag(fighter.object(), vars::duckhunt::instance::SPECIAL_HI_AERIAL_USED) {
    ...
    if MotionModule::is_end(fighter.module_accessor) {
        if VarModule::is_flag(fighter.object(), vars::duckhunt::instance::SPECIAL_HI_AERIAL_USED) {
...
pub unsafe extern "C" fn attack_air_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.object(), vars::duckhunt::instance::SPECIAL_HI_AERIAL_USED) {
        ...
        VarModule::off_flag(fighter.object(), vars::duckhunt::instance::SPECIAL_HI_AERIAL_USED);
    }
