...
unsafe fn bayonetta_attack_100_game(fighter: &mut L2CAgentBase) {
    ...
    for _ in 0..99 {
        if is_excute(fighter) {
        ATTACK(fighter, 0, 0, Hash40::new("top"), 0.55, 35, 25, 0, 10, 3.6, 0.0, 8.9, 11.5, Some(0.0), Some(8.9), Some(3.3), 0.6, 0.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_rush"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
        ATTACK(fighter, 1, 0, Hash40::new("top"), 0.55, 365, 20, 6, 30, 6.6, 0.0, 9.0, 13.7, Some(0.0), Some(9.0), Some(6.3), 0.6, 0.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_rush"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_PUNCH);
