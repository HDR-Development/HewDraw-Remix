...
unsafe fn flutter_kick(boma: &mut BattleObjectModuleAccessor, id: usize, situation_kind: i32, motion_kind: u64, frame: f32) {
    if motion_kind == hash40("attack_air_lw") {
        ...
        if  !VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISEN) {
            if frame <= 44.0 {
                if ControlModule::check_button_on(boma, *CONTROL_PAD_BUTTON_SPECIAL)
                    ...
                    VarModule::on_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISING);
                    KineticModule::add_speed_outside(boma, *KINETIC_OUTSIDE_ENERGY_TYPE_WIND_NO_ADDITION, &motion_vec);

                    if VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISING) &&  !VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISEN) {
                        // Reset momentum on the rise initialization
                        if  !VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_MOMENTUM_RESET){
                            // Reset momentum
                            ...
                            VarModule::on_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_MOMENTUM_RESET);
                        }
                    }
    ...
    if VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISING) && (motion_kind != hash40("attack_air_lw") || (motion_kind == hash40("attack_air_lw") && frame > 44.0)) {
        VarModule::on_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISEN);
        VarModule::off_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISING);
        VarModule::off_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_MOMENTUM_RESET);
    }
    if situation_kind == *SITUATION_KIND_GROUND && VarModule::is_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISEN) {
        VarModule::off_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_RISEN);
        VarModule::off_flag(boma.object(), vars::yoshi::status::AERIAL_COMMAND_MOMENTUM_RESET);
    }
}
