...
unsafe fn sephiroth_attack_13_effect(fighter: &mut L2CAgentBase) {
    ...
    frame(lua_state, 2.0);
    if is_excute(fighter) {
        EFFECT_FOLLOW(fighter, Hash40::new("edge_attack_dash"), Hash40::new("swordl1"), -8.0, 0, -1.0, 0, 0, 0, 1.0, true);
        LAST_EFFECT_SET_RATE(fighter, 1.25);
        EFFECT_FOLLOW(fighter, Hash40::new("edge_attack_dash_aura"), Hash40::new("swordl1"), -8.0, 0, -1.0, 0, 0, 0, 1.0, true);
        LAST_EFFECT_SET_RATE(fighter, 1.25);
    }
    frame(lua_state, 7.0);
    if is_excute(fighter) {
        ...
        EFFECT_FOLLOW(fighter, Hash40::new("edge_attack_dash2"), Hash40::new("swordl1"), -8.0, 0, -1.0, 0, 0, 0, 0.85, true);
