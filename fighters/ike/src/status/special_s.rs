...
unsafe extern "C" fn special_s_dash_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StopModule::is_stop(fighter.module_accessor) {
        special_s_dash_substatus(fighter, false.into());
    }
    ...
    fighter.global_table[SUB_STATUS].assign(&L2CValue::Ptr(special_s_dash_substatus as *const () as _));
    special_s_dash_mot_helper(fighter);
    fighter.sub_shift_status_main(L2CValue::Ptr(ike_special_s_dash_main_loop as *const () as _))
}

unsafe extern "C" fn special_s_dash_substatus(fighter: &mut L2CFighterCommon, param_1: L2CValue) -> L2CValue {
    if param_1.get_bool() {
...
unsafe extern "C" fn special_s_main_loop_helper(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn special_s_dash_mot_helper(fighter: &mut L2CFighterCommon) {
...
unsafe extern "C" fn ike_special_s_dash_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    special_s_main_loop_helper(fighter);
    0.into()
}
