...
pub fn install() {
    smashline::Agent::new("ike")
        .acmd("game_attacks3hi", ike_attack_s3_hi_game)
        .acmd("game_attacks3", ike_attack_s3_s_game)
        .acmd("game_attacks3lw", ike_attack_s3_lw_game)
        .acmd("expression_attacks3hi", ike_attack_s3_expression)
        .acmd("expression_attacks3", ike_attack_s3_expression)
        .acmd("expression_attacks3lw", ike_attack_s3_expression)
        .acmd("game_attackhi3", ike_attack_hi3_game)
        .acmd("game_attacklw3", ike_attack_lw3_game)
        .acmd("expression_attacklw3", ike_attack_lw3_expression)
        .install();
}
