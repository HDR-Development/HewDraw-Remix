...
unsafe extern "C" fn game_attackdash(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 11.0);
    if is_excute(agent) {
        shield!(agent, *MA_MSC_CMD_REFLECTOR, *COLLISION_KIND_REFLECTOR, 0, hash40("top"), 5.5, 0.0, 8.5, 4.0, 0.0, 8.5, 4.75, 1.55, 0.8, 999, false, 0.8, *FIGHTER_REFLECTOR_GROUP_HOMERUNBAT);
    }
