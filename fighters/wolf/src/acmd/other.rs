...
pub fn install() {
    smashline::Agent::new("wolf")
        ...
        .install();
    smashline::Agent::new("wolf_blaster_bullet")
        .acmd("game_fly", wolf_blaster_bullet_fly_game)
        .install();
}
