...
unsafe fn attack_s4_start_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::get_int(fighter.object(), vars::packun::instance::CURRENT_STANCE) == 2 {
        MotionModule::change_motion(fighter.module_accessor, Hash40::new("attack_s4_2"), 0.0, 1.0, false, 0.0, false, false);
    }
...
unsafe fn attack_s4_hold_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::get_int(fighter.object(), vars::packun::instance::CURRENT_STANCE) == 2 {
        MotionModule::change_motion(fighter.module_accessor, Hash40::new("attack_s4_hold_2"), 0.0, 1.0, false, 0.0, false, false);
    }
...
unsafe fn attack_s4_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::get_int(fighter.object(), vars::packun::instance::CURRENT_STANCE) == 2 {
        MotionModule::change_motion(fighter.module_accessor, Hash40::new("attack_s4_2"), 24.0, 1.0, false, 0.0, false, false);
    }
