...
unsafe extern "C" fn special_hi_drop_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
    StatusModule::init_settings(fighter.module_accessor,
...
pub fn install(agent: &mut Agent) {
    ...
    agent.status(Pre, *FIGHTER_LUIGI_STATUS_KIND_SPECIAL_HI_DROP, special_hi_drop_pre);
}