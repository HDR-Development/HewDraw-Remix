...
unsafe extern "C" fn game_specialn1firemax(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
	frame(lua_state, 1.0);
    if is_excute(agent) {
...
unsafe extern "C" fn game_specialn1neon(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
	frame(lua_state, 1.0);
...
unsafe extern "C" fn effect_specialn1neon(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
	frame(lua_state, 1.0);
	if is_excute(agent) {
...
unsafe extern "C" fn sound_specialn1neon(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
	frame(lua_state, 1.0);
	if is_excute(agent) {
...
unsafe extern "C" fn expression_specialn1neon(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 3.0);
    if is_excute(agent) {
...
pub fn install(agent: &mut Agent) {
    agent.acmd("game_specialn1start", game_specialn1start, Priority::Low);
    agent.acmd("game_specialairn1start", game_specialn1start, Priority::Low);

    agent.acmd("game_specialn1firemax", game_specialn1firemax, Priority::Low);
    agent.acmd("game_specialairn1firemax", game_specialn1firemax, Priority::Low);
    agent.acmd("effect_specialn1firemax", effect_specialn1firemax, Priority::Low);
    agent.acmd("effect_specialairn1firemax", effect_specialn1firemax, Priority::Low);
    agent.acmd("sound_specialn1firemax", sound_specialn1firemax, Priority::Low);
    agent.acmd("sound_specialairn1firemax", sound_specialn1firemax, Priority::Low);

	agent.acmd("game_specialn1neon", game_specialn1neon, Priority::Low);
    agent.acmd("game_specialairn1neon", game_specialn1neon, Priority::Low);
    agent.acmd("effect_specialn1neon", effect_specialn1neon, Priority::Low);
    agent.acmd("effect_specialairn1neon", effect_specialn1neon, Priority::Low);
    agent.acmd("sound_specialn1neon", sound_specialn1neon, Priority::Low);
    agent.acmd("sound_specialairn1neon", sound_specialn1neon, Priority::Low);
	agent.acmd("expression_specialn1neon", expression_specialn1neon, Priority::Low);
    agent.acmd("expression_specialairn1neon", expression_specialn1neon, Priority::Low);

    agent.acmd("game_specialn2loop", game_specialn2loop, Priority::Low);
    agent.acmd("game_specialairn2loop", game_specialn2loop, Priority::Low);

    agent.acmd("game_specialn3start", game_specialn3start, Priority::Low);
    agent.acmd("game_specialairn3start", game_specialn3start, Priority::Low);
    agent.acmd("effect_specialn3start", effect_specialn3start, Priority::Low);
