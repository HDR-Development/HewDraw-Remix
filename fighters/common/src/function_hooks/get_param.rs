...
pub unsafe fn get_param_int_hook(x0: u64, x1: u64, x2 :u64) -> i32 {
	...
	if fighter_kind == *FIGHTER_KIND_RYU {
		if ex_special[id] && x1 == hash40("param_special_s") && (x2 == hash40("loop_num_w") || x2 == hash40("loop_num_m") || x2 == hash40("loop_num_s") || x2 == hash40("loop_num_w") || x2 == hash40("air_loop_num_m") || x2 == hash40("air_air_loop_num_s")) {
			return 3;
		}
	}
