...
#[hook(module = "common", symbol = "_ZN7lua2cpp16L2CFighterCommon51sub_ftStatusUniqProcessGuardDamage_initStatus_InnerEv")]
...
#[common_status_script(status = FIGHTER_STATUS_KIND_GUARD_DAMAGE, condition = LUA_SCRIPT_STATUS_FUNC_INIT_STATUS,
    symbol = "_ZN7lua2cpp16L2CFighterCommon45sub_ftStatusUniqProcessGuardDamage_initStatusEv")]
unsafe fn ftStatusUniqProcessGuardDamage_initStatus(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_STATUS_GUARD_ON_WORK_FLAG_JUST_SHIELD) {
        ...
        let shield_scale = if 0 < WorkModule::get_int(fighter.module_accessor, *FIGHTER_STATUS_GUARD_DAMAGE_WORK_INT_PREV_SHIELD_SCALE_FRAME) {
