...
#[hook(module = "common", symbol = "_ZN7lua2cpp16L2CFighterCommon48sub_ftStatusUniqProcessGuardOn_exitStatus_commonEv")]
...
#[common_status_script(status = FIGHTER_STATUS_KIND_GUARD_ON, condition = LUA_SCRIPT_STATUS_FUNC_EXIT_STATUS,
    symbol = "_ZN7lua2cpp16L2CFighterCommon41sub_ftStatusUniqProcessGuardOn_exitStatusEv")]
