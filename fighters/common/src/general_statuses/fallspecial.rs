...
pub unsafe fn status_fall_special(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let fall_special_cliff_hangdata_p1x_reduction_dist = ParamModule::get_float(fighter.battle_object, ParamType::Common, "fall_special_cliff_hangdata_p1x_reduction_dist");
