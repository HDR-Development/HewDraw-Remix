...
unsafe extern "C" fn effect_attackhi3(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT(agent, Hash40::new("ness_psi_atk"), Hash40::new("top"), 0, 21.5, 1, 0, -90, 0, 1.5, 0, 0, 0, 0, 0, 360, true);
    }
