...
pub fn install(agent: &mut Agent) {
    ...
    agent.status(CheckAttack, *FIGHTER_CLOUD_STATUS_KIND_SPECIAL_S3, special_s_check_attack);
    agent.status(Exec, *FIGHTER_CLOUD_STATUS_KIND_SPECIAL_S3, special_s_exec);
