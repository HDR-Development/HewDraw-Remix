...
unsafe extern "C" fn captain_special_n_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_KIRBY_STATUS_KIND_CAPTAIN_SPECIAL_N, captain_special_n_pre);
}