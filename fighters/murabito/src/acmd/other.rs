...
unsafe fn murabito_catchdash_game(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter){
        ...
        ATTACK(fighter, 2, 0, Hash40::new("top"), 0.0, 20, 0, 0, 20, 3.6, 0.0, 5.5, 4.2, Some(0.0), Some(5.5), Some(12.8), 0.0, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, true, false, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_FIGHTER, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_NONE);
        ENABLE_AREA(fighter, *FIGHTER_MURABITO_AREA_KIND_SEARCH_ITEM_CATCH);
    }
    game_CaptureCutCommon(fighter);
    for _ in 0..3 {
...
unsafe fn murabito_catchturn_game(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter){
        ...
        ATTACK(fighter, 2, 0, Hash40::new("top"), 0.0, 20, 0, 0, 20, 4.6, 0.0, 5.5, -5.2, Some(0.0), Some(5.5), Some(-13.8), 0.0, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, true, false, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_FIGHTER, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_NONE);
        ENABLE_AREA(fighter, *FIGHTER_MURABITO_AREA_KIND_SEARCH_ITEM_CATCH);
    }
    game_CaptureCutCommon(fighter);
    for _ in 0..3 {
