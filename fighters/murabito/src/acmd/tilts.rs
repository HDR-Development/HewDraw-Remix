...
unsafe extern "C" fn game_attacklw3(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        if VarModule::is_flag(boma.object(), vars::murabito::instance::ATTACK_LW3_SAPLING_PULL) {
            ...
            ATTACK(agent, 0, 0, Hash40::new("top"), 15.0, 90, 92, 0, 68, 5.5, pos_z, pos_y + 3.5, pos_x - 5.0, Some(pos_z), Some(pos_y + 3.5), Some(pos_x + 5.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 15, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_OBJECT);
        } else {
