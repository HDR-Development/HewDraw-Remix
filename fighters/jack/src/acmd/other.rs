...
#[acmd_script( agent = "jack", script = "sound_damageflyhi" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "sound_damageflylw" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "sound_damageflyn" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "sound_damageflyroll" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "sound_damageflytop" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "sound_dash" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "jack", script = "game_escapeair" , category = ACMD_GAME , low_priority)]
