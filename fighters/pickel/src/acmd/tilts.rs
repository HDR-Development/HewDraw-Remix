    ...
    if is_excute(agent) {
        ...
        if material_kind != *FIGHTER_PICKEL_MATERIAL_KIND_NONE {
            ...
            if boma.is_situation(*SITUATION_KIND_GROUND) { // ground-only locking hitbox
                ATTACK(agent, 7, 0, Hash40::new("top"), 1.5, 361, 30, 0, 20, 2.5, 0.0, 3.3, 5.4, Some(0.0), Some(3.3), Some(11.5), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
            }
            ATK_SET_SHIELD_SETOFF_MUL_arg5(agent, 0, 1, 2, 3, 0.25);
            ATK_SET_SHIELD_SETOFF_MUL_arg5(agent, 4, 5, 6, 7, 0.25);
...
unsafe extern "C" fn game_attackhi3(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        if material_kind != *FIGHTER_PICKEL_MATERIAL_KIND_NONE {
            ...
            ATTACK(agent, 0, 0, Hash40::new("armr"), 4.0, 85, 78, 0, 56, 4.4, 0.6, 0.4, 0.0, None, None, None, 1.0, 1.2, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        }
    }
    wait(lua_state, 8.0);
    if is_excute(agent) {
...
unsafe extern "C" fn effect_attackhi3(agent: &mut L2CAgentBase) {
    ...
    if material_kind != *FIGHTER_PICKEL_MATERIAL_KIND_NONE {
        ...
        if is_excute(agent) {
            ...
            LAST_EFFECT_SET_RATE(agent, if material_kind == GOLD { 0.6 } else { 0.4 });
        }
    } else {
        // fist effect
        frame(lua_state, 6.0);
