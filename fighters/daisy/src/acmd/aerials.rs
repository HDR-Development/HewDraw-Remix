...
unsafe extern "C" fn effect_attackairlw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FLIP(agent, Hash40::new("sys_attack_impact"), Hash40::new("sys_attack_impact"), Hash40::new("top"), 0, -5, 0.2, 80, 0, 0, 1.2, 0, 0, 0, 0, 0, 0, true, *EF_FLIP_NONE);
    }
}
