...
//     if is_excute(agent) {
//         ATTACK(agent, 0, 0, Hash40::new("propeller"), 3.0, 90, 30, 0, 70, 5.5, 0.0, 2.0, 0.0, Some(0.0), Some(-2.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_OBJECT);
//     }
// }
...
pub fn install(agent: &mut Agent) {
    ...
    agent.acmd("game_flywind", acmd_stub, Priority::Low);
