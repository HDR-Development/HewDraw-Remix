...
#[acmd_script( agent = "ken", script = "game_specialsex", category = ACMD_GAME, low_priority )]
unsafe fn game_specialsex(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
#[acmd_script( agent = "ken", script = "effect_specialsex", category = ACMD_EFFECT, low_priority )]
unsafe fn effect_specialsex(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    if is_excute(fighter) {
...
#[acmd_script( agent = "ken", script = "sound_specialsex", category = ACMD_SOUND, low_priority )]
unsafe fn sound_specialsex(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 1.0);
    if is_excute(fighter) {
...
#[acmd_script( agent = "ken", script = "expression_specialsex", category = ACMD_EXPRESSION, low_priority )]
unsafe fn expression_specialsex(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    if is_excute(fighter) {
