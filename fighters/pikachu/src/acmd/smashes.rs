...
unsafe extern "C" fn effect_attacks4(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        ...
        EFFECT_FOLLOW_NO_STOP(fighter, Hash40::new("pikachu_elec_shock"), Hash40::new("top"), 0, 7, 10.5, 0, 0, 0, 0.9, true);
    }
