...
unsafe extern "C" fn attack_air_n(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn attack_air_n_effect(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 3.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_n_sound(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 6.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_n_expression(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 4.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_f(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 4.0);
    if is_excute(agent) {
...
unsafe extern "C" fn samus_attack_air_f_effect(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 4.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_b(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 9.0);
    if is_excute(agent) {
...
unsafe extern "C" fn effect_air_b(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 8.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_hi(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 3.0);
    if is_excute(agent) {
...
unsafe extern "C" fn attack_air_lw(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 1.0);
    if is_excute(agent) {
...
unsafe extern "C" fn samus_attack_air_lw_effect(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    frame(lua_state, 9.0);
    if is_excute(agent) {
...
unsafe extern "C" fn samus_landing_air_catch_game(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.boma();
    if is_excute(agent) {
...
pub fn install(agent: &mut Agent) {
    agent.acmd("game_attackairn", attack_air_n);
    agent.acmd("effect_attackairn", attack_air_n_effect);
    agent.acmd("sound_attackairn", attack_air_n_sound);
    agent.acmd("expression_attackairn", attack_air_n_expression);
    agent.acmd("game_attackairf", attack_air_f);
    agent.acmd("effect_attackairf", samus_attack_air_f_effect);
    agent.acmd("game_attackairb", attack_air_b);
    agent.acmd("effect_attackairb", effect_air_b);
    agent.acmd("game_attackairhi", attack_air_hi);
    agent.acmd("game_attackairlw", attack_air_lw);
    agent.acmd("effect_attackairlw", samus_attack_air_lw_effect);
    agent.acmd("game_aircatchlanding", samus_landing_air_catch_game);
}
