...
unsafe extern "C" fn plizardon_appeal_lw_r_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
...
unsafe extern "C" fn plizardon_appeal_lw_l_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    frame(lua_state, 35.0);
    if is_excute(fighter) {
...
pub fn install() {
    smashline::Agent::new("plizardon")
        ...
        .acmd("game_appeallwr", plizardon_appeal_lw_r_game)
        .acmd("game_appeallwl", plizardon_appeal_lw_l_game)
