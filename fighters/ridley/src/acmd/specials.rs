...
unsafe extern "C" fn game_specialsstart(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        CATCH(agent, 0, Hash40::new("top"), 6.0, 0.0, 8.5, 12.5, None, None, None, *FIGHTER_STATUS_KIND_CATCHED_RIDLEY, *COLLISION_SITUATION_MASK_G);
        CATCH(agent, 1, Hash40::new("top"), 4.5, 0.0, 10.0, 14.0, None, None, None, *FIGHTER_STATUS_KIND_CATCHED_RIDLEY, *COLLISION_SITUATION_MASK_A);
        CATCH(agent, 2, Hash40::new("top"), 5.0, 0.0, 7.0, 6.5, None, None, None, *FIGHTER_STATUS_KIND_CATCHED_RIDLEY, *COLLISION_SITUATION_MASK_G);
...
unsafe extern "C" fn game_specialsdragcliff(agent: &mut L2CAgentBase) {
    ...
    let boma = agent.boma();
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 7.0, 42, 107, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
unsafe extern "C" fn game_specialairhichargehi(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        // HIT_NODE(agent, Hash40::new("wingr2"), *HIT_STATUS_XLU);
        // HIT_NODE(agent, Hash40::new("wingl2"), *HIT_STATUS_XLU);
        ATTACK(agent, 0, 0, Hash40::new("rot"), 18.0, 64, 46, 0, 85, 4.0, 0.0, 10.0, 0.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    ...
    frame(lua_state, 10.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("rot"), 12.0, 64, 36, 0, 100, 4.0, 0.0, 10.0, 0.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
        ATTACK(agent, 1, 0, Hash40::new("rot"), 12.0, 64, 36, 0, 100, 6.0, 0.0, 1.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
    frame(lua_state, 25.0);
    if is_excute(agent) {
        AttackModule::clear_all(boma);
...
unsafe extern "C" fn game_specialairhichargelw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 0, 0, Hash40::new("rot"), 15.0, 295, 35, 0, 50, 6.5, 0.0, -13.0, 2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("rot"), 15.0, 44, 50, 0, 85, 6.5, 0.0, -13.0, 2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
    frame(lua_state, 19.0);
    if is_excute(agent) {
        AttackModule::clear_all(boma);
...
unsafe extern "C" fn game_speciallwstab(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        if grab_y == 0.0 {
            ATTACK(agent, 0, 0, Hash40::new("top"), 45.0, 25, 10, 0, 70, 2.2, 0.0, 7.0, 24.5, Some(0.0), Some(7.0), Some(29.5), 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 25.0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_FIGHTER, *COLLISION_PART_MASK_BODY_HEAD, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_TAIL);
            ATTACK(agent, 1, 0, Hash40::new("top"), 45.0, 25, 10, 0, 70, 2.2, 0.0, 7.0, 24.5, Some(0.0), Some(7.0), Some(29.5), 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 25.0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FIGHTER, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_TAIL);
        ...
        // angle up
            ...
            z_mod = 3.0 * grab_y;
            ATTACK(agent, 0, 0, Hash40::new("top"), 45.0, 25, 10, 0, 70, 2.2, 0.0, (grab_y * 7.0) + 8.0, 24.5 - z_mod, Some(0.0), Some((grab_y * 11.0) + 7.0), Some(29.5 - z_mod), 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 25.0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_FIGHTER, *COLLISION_PART_MASK_BODY_HEAD, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_TAIL);
            ATTACK(agent, 1, 0, Hash40::new("top"), 45.0, 25, 10, 0, 70, 2.2, 0.0, (grab_y * 7.0) + 8.0, 24.5 - z_mod, Some(0.0), Some((grab_y * 11.0) + 7.0), Some(29.5 - z_mod), 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 25.0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FIGHTER, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_TAIL);
...
unsafe extern "C" fn game_speciallwpogo(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 2, 0, Hash40::new("tail8"), 12.0, 46, 70, 0, 70, 3.0, 4.0, 0.0, 0.0, None, None, None, 1.1, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_TAIL);
...
pub fn install(agent: &mut Agent) {
    ...
    agent.acmd("game_specialairnhold", game_specialnhold, Priority::Low);
    ...
    agent.acmd("game_specialnexplode", game_specialnexplode, Priority::Low);
    agent.acmd("effect_specialnexplode", effect_specialnexplode, Priority::Low);
    agent.acmd("sound_specialnexplode", sound_specialnexplode, Priority::Low);
    agent.acmd("expression_specialnexplode", expression_specialnexplode, Priority::Low);
    agent.acmd("game_specialairnexplode", game_specialnexplode, Priority::Low);
    agent.acmd("effect_specialairnexplode", effect_specialairnexplode, Priority::Low);
    agent.acmd("sound_specialairnexplode", sound_specialnexplode, Priority::Low);
    agent.acmd("expression_specialairnexplode", expression_specialnexplode, Priority::Low);
    ...
    agent.acmd("effect_specialairlwstab", effect_speciallwstab, Priority::Low);
    agent.acmd("game_speciallwfinish", game_speciallwfinish, Priority::Low);
    agent.acmd("game_specialairlwfinish", game_speciallwfinish, Priority::Low);
    agent.acmd("game_specialairlwpogo", game_speciallwpogo, Priority::Low);
    agent.acmd("effect_specialairlwpogo", effect_speciallwpogo, Priority::Low);
    agent.acmd("sound_specialairlwpogo", sound_speciallwpogo, Priority::Low);
    agent.acmd("expression_specialairlwpogo", expression_speciallwpogo, Priority::Low);
    agent.acmd("game_speciallwpogolanding", game_speciallwpogolanding, Priority::Low);
    agent.acmd("effect_speciallwpogolanding", effect_speciallwpogolanding, Priority::Low);
    agent.acmd("sound_speciallwpogolanding", sound_speciallwpogolanding, Priority::Low);
    agent.acmd("expression_speciallwpogolanding", expression_speciallwpogolanding, Priority::Low);
}
