...
unsafe fn demon_attack_s4_game(fighter: &mut L2CAgentBase) {
...
unsafe fn demon_attack_hi4_game(fighter: &mut L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    let boma = fighter.boma();
    smash::app::FighterSpecializer_Demon::set_devil(boma, true, 10.0);
    frame(lua_state, 1.0);
...
pub fn install() {
    install_acmd_scripts!(
        demon_attack_s4_game,
        demon_attack_hi4_game,
