...
unsafe extern "C" fn game_specialng(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 0, 0, Hash40::new("top"), 2.5, 366, 40, 70, 0, 6.0, 0.0, 6.0, 0.0, None, None, None, 0.8, 0.5, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 5, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_ITEM, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_MAGIC);
        ATTACK(agent, 1, 0, Hash40::new("top"), 2.5, 366, 40, 70, 0, 6.0, 0.0, 12.0, -2.0, Some(0.0), Some(12.0), Some(2.0), 0.8, 0.5, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 5, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_ITEM, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_MAGIC);
        ATTACK(agent, 2, 0, Hash40::new("top"), 2.5, 366, 40, 70, 0, 6.0, 0.0, 18.0, -3.0, Some(0.0), Some(18.0), Some(3.0), 0.8, 0.5, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, true, 0, 0.0, 5, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_ITEM, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_MAGIC);
    }
    wait(lua_state, 25.0);
...
unsafe extern "C" fn effect_specialng(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_club_tornado"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 1, true);
        LAST_EFFECT_SET_COLOR(agent, 0.05, 1.0, 0.05);
        EFFECT_FOLLOW(agent, Hash40::new("sys_club_tornado"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 0.95, true);
        LAST_EFFECT_SET_COLOR(agent, 0.05, 0.50, 0.05);
    }
    wait(lua_state, 1.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_club_tornado"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 1.2, true);
...
pub fn install(agent: &mut Agent) {
    agent.acmd("game_specialng", game_specialng, Priority::Low);
    agent.acmd("game_specialairng", game_specialng, Priority::Low);
    agent.acmd("effect_specialng", effect_specialng, Priority::Low);
    agent.acmd("effect_specialairng", effect_specialng, Priority::Low);
    agent.acmd("sound_specialng", sound_specialng, Priority::Low);
    agent.acmd("sound_specialairng", sound_specialng, Priority::Low);
    agent.acmd("expression_specialng", expression_specialng, Priority::Low);
    agent.acmd("expression_specialairng", expression_specialng, Priority::Low);
}