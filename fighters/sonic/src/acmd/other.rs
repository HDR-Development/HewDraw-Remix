...
#[acmd_script( agent = "sonic", script = "sound_dash" , category = ACMD_SOUND , low_priority)]
...
#[acmd_script( agent = "sonic", script = "game_escapeair" , category = ACMD_GAME , low_priority)]
