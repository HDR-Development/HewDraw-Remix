...
unsafe extern "C" fn special_n_cancel_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    if fighter.global_table[SITUATION_KIND] == SITUATION_KIND_GROUND {
        ...
        MotionModule::change_motion(fighter.module_accessor, Hash40::new("invalid"), 0.0, 1.0, false, 0.0, false, false);
    }
    else {
...
unsafe extern "C" fn special_n_cancel_main_loop_electric_boogaloo(fighter: &mut L2CFighterCommon) -> L2CValue {
    if fighter.global_table[SITUATION_KIND] == SITUATION_KIND_GROUND {
        match VarModule::get_int(fighter.battle_object, vars::littlemac::status::SPECIAL_N_CANCEL_TYPE) {
            ...
            vars::littlemac::SPECIAL_N_CANCEL_TYPE_GUARD => fighter.change_status(FIGHTER_STATUS_KIND_GUARD_ON.into(), false.into()),
