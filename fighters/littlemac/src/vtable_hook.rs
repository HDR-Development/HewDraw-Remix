...
pub unsafe extern "C" fn hook_ko_meter_gain(vtable: u64, battle_object: *mut BattleObject, collisionLog: CollisionLog, damage: f32) -> u64 {
    ...
    if opponent_boma.is_status_one_of(&[
        ...
        *FIGHTER_STATUS_KIND_ATTACK_LW4_HOLD]) {
        EffectModule::req_on_joint(boma, Hash40::new("sys_piyo"), Hash40::new("head"), &Vector3f::new(2.5, 0.0, 2.0), &Vector3f::new(0.0, 190.0, 0.0), 1.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
        meter_gain = 30.0;
    }
