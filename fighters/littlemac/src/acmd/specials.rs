...
unsafe extern "C" fn game_specialn(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        let (mut damage, hitlag, shield_damage, sfx_lvl, sound_attr) = match meter_lvl {
            0 => {(
                (9.0 + meter / 8.0), 1.0, 10, *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_PUNCH
            )},
            1 => {(
                (9.0 + meter / 8.0), 1.2, 20, *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH
            )}
            _ => {(
        ...
        let (bkb, kbg) = if agent.is_situation(*SITUATION_KIND_GROUND) { (40, 93) } else { (30, 118) };
        ATTACK(agent, 0, 0, Hash40::new("armr"), damage, 80, kbg, 0, bkb, 5.0, 3.0, 0.0, 0.0, None, None, None, hitlag, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, shield_damage, 0.0, 0, false, false, false, true, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), sfx_lvl, sound_attr, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("armr"), damage, 80, kbg, 0, bkb, 3.0, -1.0, 0.0, 0.0, None, None, None, hitlag, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, shield_damage, 0.0, 0, false, false, false, true, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), sfx_lvl, sound_attr, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 2, 0, Hash40::new("shoulderr"), damage, 80, kbg, 0, bkb, 3.0, 0.0, 0.0, 0.0, None, None, None, hitlag, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, shield_damage, 0.0, 0, false, false, false, true, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), sfx_lvl, sound_attr, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 3, 0, Hash40::new("bust"), damage, 80, kbg, 0, bkb, 3.0, 0.0, 0.0, 0.0, None, None, None, hitlag, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, shield_damage, 0.0, 0, false, false, false, true, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), sfx_lvl, sound_attr, *ATTACK_REGION_PUNCH);
...
unsafe extern "C" fn game_specialairsblow(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 0, 0, Hash40::new("arml"), 12.0, 361, 68, 0, 75, 5.0, 3.0, 0.0, 0.0, None, None, None, 1.1, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("shoulderl"), 12.0, 361, 68, 0, 75, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.1, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 2, 0, Hash40::new("top"), 12.0, 361, 68, 0, 75, 3.5, 0.0, 4.5, 5.0, None, None, None, 1.1, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
    }
    frame(lua_state, 7.0);
    if is_excute(agent) {
        AttackModule::clear_all(boma);
...
unsafe extern "C" fn game_specialhistart(agent: &mut L2CAgentBase) {
    ...
    let boma = agent.boma();
    if is_excute(agent) {
        VarModule::on_flag(boma.object(), vars::littlemac::instance::SPECIAL_HI_GROUND_START);
    }
    frame(lua_state, 1.0);
...
unsafe extern "C" fn game_specialhi(agent: &mut L2CAgentBase) {
    ...
    FT_MOTION_RATE(agent, 1.0);
    if is_excute(agent) {
        if VarModule::is_flag(boma.object(), vars::littlemac::instance::SPECIAL_HI_GROUND_START) {
            ATTACK(agent, 0, 0, Hash40::new("top"), 3.0, 85, 207, 0, 45, 6.5, 0.0, 22.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        }
        else {
    ...
    if is_excute(agent) {
        ...
        let fall_x_mul = WorkModule::get_param_float(boma, hash40("param_special_hi"), hash40("special_hi_fall_x_mul"));
...
unsafe extern "C" fn effect_specialhi(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW_NO_STOP(agent, Hash40::new("littlemac_risinguppercut_impact"), Hash40::new("handl"), 0, 0, 0, 0, 0, 0, 0.8, true);
        EFFECT_FOLLOW_NO_STOP(agent, Hash40::new("littlemac_risinguppercut_splash"), Hash40::new("handl"), 0, 0, 0, 0, 0, 0, 0.8, false);
    }
    frame(lua_state, 27.0);
    if is_excute(agent) {
...
pub fn install(agent: &mut Agent) {
    ...
    agent.acmd("effect_specialairsblow", effect_specialairsblow, Priority::Low);
    ...
    agent.acmd("game_speciallwhitf", game_speciallwhit, Priority::Low);
    agent.acmd("game_specialairlwhitf", game_speciallwhit, Priority::Low);
    agent.acmd("effect_speciallwhitf", effect_speciallwhit, Priority::Low);
    agent.acmd("effect_specialairlwhitf", effect_speciallwhit, Priority::Low);
    agent.acmd("sound_speciallwhitf", sound_speciallwhit, Priority::Low);
    agent.acmd("sound_specialairlwhitf", sound_speciallwhit, Priority::Low);
    agent.acmd("expression_speciallwhitf", expression_speciallwhit, Priority::Low);
    agent.acmd("expression_specialairlwhitf", expression_speciallwhit, Priority::Low);
}