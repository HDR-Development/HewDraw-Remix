...
unsafe extern "C" fn game_attack11(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        // Locking hitbox
        ATTACK(agent, 2, 0, Hash40::new("top"), 3.0, 361, 15, 0, 30, 4.3, 0.0, 5.0, 6.0, Some(0.0), Some(5.0), Some(13.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_OBJECT);
    }
    frame(lua_state, 6.0);
    if is_excute(agent) {
...
unsafe extern "C" fn effect_attack12(agent: &mut L2CAgentBase) {
    ...
    let boma = agent.boma();
    if is_excute(agent) {
        // EFFECT(agent, Hash40::new("sys_smash_flash_s"), Hash40::new("havel"), 0, 0, 0, 0, 0, 0, 1.5, 3, 3, 3, 0, 0, 0, false);
