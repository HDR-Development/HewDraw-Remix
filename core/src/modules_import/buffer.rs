...
extern "Rust" {
    #[link_name = "BufferModule__clear_command_one"]
    fn persist_command_one(object: *mut BattleObject, category: i32, flag: i32);

    #[link_name = "BufferModule__persist_command_one_with_lifetime"]
    fn persist_command_one_with_lifetime(object: *mut BattleObject, category: i32, flag: i32, lifetime: i32);

    #[link_name = "BufferModule__set_persist_lifetime"]
    fn set_persist_lifetime(object: *mut BattleObject, lifetime: i32);

    #[link_name = "BufferModule__enable_persist"]
    fn enable_persist(object: *mut BattleObject);

    #[link_name = "BufferModule__disable_persist"]
    fn disable_persist(object: *mut BattleObject);

    #[link_name = "BufferModule__clear_persist"]
    fn clear_persist(object: *mut BattleObject);

    #[link_name = "BufferModule__clear_persist_one"]
    fn clear_persist_one(object: *mut BattleObject, category: i32, flag: i32);

    #[link_name = "BufferModule__exec"]
    fn exec(object: *mut BattleObject, cats: &mut [&mut [u8]; 4]);

    #[link_name = "BufferModule__is_persist"]
    fn is_persist(object: *mut BattleObject) -> bool;

    #[link_name = "BufferModule__is_persist_one"]
    fn is_persist_one(object: *mut BattleObject, category: i32, flag: i32) -> bool;

    #[link_name = "BufferModule__persist_lifetime"]
    fn persist_lifetime(object: *mut BattleObject) -> i32;

    #[link_name = "BufferModule__persist_lifetime_one"]
    fn persist_lifetime_one(object: *mut BattleObject, category: i32, flag: i32) -> i32;

    #[link_name = "BufferModule__persist_lifetime_max_one"]
    fn persist_lifetime_max_one(object: *mut BattleObject, category: i32, flag: i32) -> i32;
}
...
pub mod BufferModule {
    ...
    pub fn persist_command_one(object: *mut BattleObject, category: i32, flag: i32) {
        unsafe {
            super::persist_command_one(object, category, flag)
        }
    }
    ...
    pub fn persist_command_one_with_lifetime(object: *mut BattleObject, category: i32, flag: i32, lifetime: i32) {
        unsafe {
            super::persist_command_one_with_lifetime(object, category, flag, lifetime)
        }
    }
    ...
    pub fn set_persist_lifetime(object: *mut BattleObject, lifetime: i32) {
        unsafe {
            super::set_persist_lifetime(object, lifetime)
        }
    }
    ...
    pub fn clear_persist_one(object: *mut BattleObject, category: i32, flag: i32) {
        unsafe {
            super::clear_persist_one(object, category, flag)
        }
    }
    ...
    pub fn is_persist_one(object: *mut BattleObject, category: i32, flag: i32) -> bool {
        unsafe {
            super::is_persist_one(object, category, flag)
        }
    }
    ...
    pub fn persist_lifetime_one(object: *mut BattleObject, category: i32, flag: i32) -> i32 {
        unsafe {
            super::persist_lifetime_one(object, category, flag)
        }
    }
    ...
    pub fn persist_lifetime_max_one(object: *mut BattleObject, category: i32, flag: i32) -> i32 {
        unsafe {
            super::persist_lifetime_max_one(object, category, flag)
        }
    }
}