...
const FOREGROUND_CYAN: [f32; 4] = [15.0 / 255.0, 238.0 / 255.0, 238.0 / 255.0, 1.0];
const FOREGROUND_NOTREADY_CYAN: [f32; 4] = [82.0 / 255.0, 118.0 / 255.0, 118.0 / 255.0, 1.0];
const FOREGROUND_BLACK: [f32; 4] = [6.0 / 255.0, 67.0 / 255.0, 136.0 / 255.0, 1.0];
const FOREGROUND_NOTREADY_BLACK: [f32; 4] = [6.0 / 255.0, 67.0 / 255.0, 136.0 / 255.0, 1.0];
...
impl CyanMeter {
    ...
    pub fn set_tex_coords(&mut self) {
        ...
        set_pane_colors(self.bars[0], FOREGROUND_CYAN, FOREGROUND_BLACK);
        set_pane_colors(self.bars[1], FOREGROUND_CYAN, FOREGROUND_BLACK);
        ...
        if self.visual_percentage >= 0.5 {
            ...
            if self.visual_percentage >= 1.0 {
                ...
                set_pane_colors(self.bars[1], FOREGROUND_NOTREADY_CYAN, FOREGROUND_NOTREADY_BLACK);
            }
        } else {
            ...
            set_pane_visible(self.bars[0], true);
            set_pane_colors(self.bars[0], FOREGROUND_NOTREADY_CYAN, FOREGROUND_NOTREADY_BLACK);
        }
    }
