...
const BACKGROUND_WHITE: [f32; 4] = [255.0 / 255.0, 255.0 / 255.0, 153.0 / 255.0, 1.0];
const BACKGROUND_BLACK: [f32; 4] = [255.0 / 255.0, 255.0 / 255.0, 0.0 / 255.0, 1.0];

const FOREGROUND_CHARGE_WHITE: [f32; 4] = [244.0 / 255.0, 177.0 / 255.0, 31.0 / 255.0, 1.0];
const FOREGROUND_CHARGE_BLACK: [f32; 4] = [88.0 / 255.0, 61.0 / 255.0, 4.0 / 255.0, 1.0];
