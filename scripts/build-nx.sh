...
curl -T target/aarch64-skyline-switch/release/libhdr.nro ftp://${ip}:5000${nx_plugin_path}/libhdr.nro
...
do
    ...
    curl -T "$file" ftp://${ip}:5000${nx_mod_path}${parent_path}/ --ftp-create-dirs
done