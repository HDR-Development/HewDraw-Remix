...
def install_with_ip(ip: str, is_dev: bool):
  ...
  if os.name == 'nt':
    ...
    if not is_dev:
      os.system('curl -T ../plugin/target/aarch64-skyline-switch/release/libhdr.nro ftp://' + ip + ':5000/ultimate/mods/hdr/plugin.nro')
    else:
      ...
      os.system('curl -T ../plugin/target/standalone/aarch64-skyline-switch/release/libhdr.nro ftp://' + ip + ':5000/ultimate/mods/hdr/plugin.nro')
