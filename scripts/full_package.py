...
#urllib.request.urlretrieve("https://github.com/blu-dev/smashline_hook/releases/download/2.0.0/libsmashline_hook_development.nro", "libsmashline_hook_development.nro")
