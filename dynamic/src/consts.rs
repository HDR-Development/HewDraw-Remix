...
pub mod vars {
    ...
    pub mod zelda {
        pub mod instance {
            ...
            pub const SPECIAL_S_DEIN_OBJECT_ID: i32 = 0x0101;
            pub const SPECIL_S_DEIN_OBJECT_ID_2: i32 = 0x0102;
            pub const SPECIAL_S_DEIN_FLASH_EFFECT_HANDLE: i32 = 0x0103;
            pub const SPECIAL_S_DEIN_FIRE_EFFECT_HANDLE: i32 = 0x0104;
            pub const SPECIAL_LW_PHANTOM_EFFECT_HANDLE: i32 = 0x0105;
            pub const SPECIAL_LW_COOLDOWN_EFFECT_HANDLE: i32 = 0x0106;
            pub const PHANTOM_OBJECT_ID: i32 = 0x0107;

            // floats
            pub const TELEPORT_END_SPEED_X: i32 = 0x0100;
        }
        pub mod status {
            // flags
