...
pub mod vars {
    ...
    pub mod buddy {
        pub mod instance {
            ...
            pub const SPECIAL_HI_FREEFALL: i32 = 0x0103;
    ...
    pub mod demon {
        pub mod instance {
            ...
            pub const SPECIAL_HI_FREEFALL: i32 = 0x0104;
        }
    }
    ...
    pub mod mewtwo {
        pub mod instance {
            ...
            pub const SPECIAL_HI_FREEFALL: i32 = 0x0101;
        }
    }
    ...
    pub mod sheik {
        pub mod instance {
            // flags
            pub const BOUNCING_FISH_HIT: i32 = 0x0100;
        }
    }
