...
impl BomaExt for BattleObjectModuleAccessor {
    ...
    unsafe fn handle_waveland(&mut self, require_airdodge: bool) -> bool {
        ...
        let ecb_bottom_offset_y = crate::VarModule::get_float(
            self.object(),
        ...
        ) <= 0.0
        {
            ...
            (ecb_bottom_offset_y).max(crate::ParamModule::get_float(
                self.object(),
        ...
        GroundModule::line_segment_check(
            self,
            &Vector2f::new(ecb_bottom.x, ecb_bottom_y),
            &line_bottom,
            &Vector2f::zero(),
            &mut ground_pos_any,
            true,
        ...
        GroundModule::line_segment_check(
            ...
            &line_bottom,
            &Vector2f::zero(),
            &mut ground_pos_stage,
            false,
        );
        let can_snap = ground_pos_any != Vector2f::zero()
