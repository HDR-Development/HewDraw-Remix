...
mod impl_ {
    ...
    extern "C" {
        #[link_name = "_ZN3app24FighterSpecializer_Falco14final_end_execERNS_7FighterE"]
        pub(super) fn final_end_exec(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco14final_end_exitERNS_7FighterE"]
        pub(super) fn final_end_exit(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco14final_end_initERNS_7FighterE"]
        pub(super) fn final_end_init(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco16final_ready_execERNS_7FighterE"]
        pub(super) fn final_ready_exec(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco16final_ready_exitERNS_7FighterE"]
        pub(super) fn final_ready_exit(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco20final_ready_exit_preERNS_7FighterE"]
        pub(super) fn final_ready_exit_pre(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco16final_ready_initERNS_7FighterE"]
        pub(super) fn final_ready_init(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco26final_remove_screen_effectEv"]
        pub(super) fn final_remove_screen_effect();
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco26final_scene01_exec_fix_posERNS_7FighterE"]
        pub(super) fn final_scene01_exec_fix_pos(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco18final_scene01_exitERNS_7FighterE"]
        pub(super) fn final_scene01_exit(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco18final_scene01_initERNS_7FighterE"]
        pub(super) fn final_scene01_init(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco16final_start_exitERNS_7FighterE"]
        pub(super) fn final_start_exit(fighter: *mut app::Fighter);
    
        #[link_name = "_ZN3app24FighterSpecializer_Falco16final_start_initERNS_7FighterE"]
